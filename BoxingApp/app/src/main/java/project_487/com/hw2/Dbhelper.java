...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME = "BoxersDB";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        try {
            sqLiteDatabase.execSQL(BoxersDB.CREATE_TABLE_SQL);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        try {
            sqLiteDatabase.execSQL(BoxersDB.DROP_TABLE_SQL);
    ...
    public Cursor getAllRecordsMethod2(String sql, String... where) {
        Cursor cursor = db.rawQuery("select * from " + BoxersDB.TABLE_NAME, where);
        Log.d("DATABASE OPERATIONS", "GET THE RECORDS");
